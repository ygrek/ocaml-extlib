...
*)
let test () =
  Util.run_test ~test_name:"jh_BitSet2.test_intersect" test_intersect;
  Util.run_test ~test_name:"jh_BitSet2.test_diff" test_diff;
  Util.run_test ~test_name:"jh_BitSet2.test_rnd_creation" test_rnd_creation;
  Util.run_test ~test_name:"jh_BitSet2.test_empty" test_empty;
  Util.run_test ~test_name:"jh_BitSet2.test_exceptions" test_exceptions;
